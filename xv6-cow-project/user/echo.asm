...
main(int argc, char *argv[])
{
  ...
  34:	7f0a8a93          	addi	s5,s5,2032 # 820 <malloc+0x106>
  ...
  76:	7b658593          	addi	a1,a1,1974 # 828 <malloc+0x10e>
  7a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3de:	4b650513          	addi	a0,a0,1206 # 890 <digits>
 3e2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e4:	35870713          	addi	a4,a4,856 # 838 <malloc+0x11e>
 ...
 570:	324b8b93          	addi	s7,s7,804 # 890 <digits>
 ...
 5c6:	26e90913          	addi	s2,s2,622 # 830 <malloc+0x116>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a6:	5c67b783          	ld	a5,1478(a5) # c68 <freep>
 ...
 6ce:	00e6ea63          	bltu	a3,a4,6e2 <free+0x4a>
{
 ...
 710:	54f73e23          	sd	a5,1372(a4) # c68 <freep>
}
 714:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 73a:	53253503          	ld	a0,1330(a0) # c68 <freep>
 ...
 76a:	50290913          	addi	s2,s2,1282 # c68 <freep>
  if(p == (char*)-1)
 76e:	5afd                	li	s5,-1
 ...
 77e:	4f678793          	addi	a5,a5,1270 # c70 <base>
 782:	00000717          	auipc	a4,0x0
 786:	4ef73323          	sd	a5,1254(a4) # c68 <freep>
 78a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7fc:	46a73823          	sd	a0,1136(a4) # c68 <freep>
      return (void*)(p + 1);
