...
main(int argc, char *argv[])
{
  ...
  44:	7c858593          	addi	a1,a1,1992 # 808 <malloc+0x102>
  48:	4509                	li	a0,2
  ...
  62:	7c258593          	addi	a1,a1,1986 # 820 <malloc+0x11a>
  66:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	4da50513          	addi	a0,a0,1242 # 8a0 <digits>
 3ce:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d0:	37c70713          	addi	a4,a4,892 # 848 <malloc+0x142>
 ...
 55c:	348b8b93          	addi	s7,s7,840 # 8a0 <digits>
 ...
 5b2:	29290913          	addi	s2,s2,658 # 840 <malloc+0x13a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 692:	5ea7b783          	ld	a5,1514(a5) # c78 <freep>
 ...
 6ba:	00e6ea63          	bltu	a3,a4,6ce <free+0x4a>
{
 ...
 6fc:	58f73023          	sd	a5,1408(a4) # c78 <freep>
}
 700:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 726:	55653503          	ld	a0,1366(a0) # c78 <freep>
 ...
 756:	52690913          	addi	s2,s2,1318 # c78 <freep>
  if(p == (char*)-1)
 75a:	5afd                	li	s5,-1
 ...
 76a:	51a78793          	addi	a5,a5,1306 # c80 <base>
 76e:	00000717          	auipc	a4,0x0
 772:	50f73523          	sd	a5,1290(a4) # c78 <freep>
 776:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7e8:	48a73a23          	sd	a0,1172(a4) # c78 <freep>
      return (void*)(p + 1);
